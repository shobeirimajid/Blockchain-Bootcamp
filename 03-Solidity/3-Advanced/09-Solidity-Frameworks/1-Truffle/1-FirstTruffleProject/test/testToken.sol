...
contract TestMyToken {
    ...
    function beforeAll() public {
        ...
        // acc0.balance - initialBalance
        acc0_InitialBalance = acc0.balance;
    ...
    function testInitialInfo() public {
        ...
        console.log("TestMyToken balance:           ", address(this).balance);
    ...
    function testTokenTransfer() public {
        ...
        Assert.equal(mtk.balanceOf(owner), 1000, "balance of owner should be 1000");
        Assert.equal(mtk.balanceOf(acc1), 0, "balance of acc1 should be 0");

        // Make transaction from address(this)/owner to acc1.
        mtk.transfer(acc1, 200);

        // Check the balances of owner and acc1 after transaction.
        Assert.equal(mtk.balanceOf(owner), 800, "balance of owner should be 800");
        Assert.equal(mtk.balanceOf(acc1), 200, "balance of acc1 should be 200");
    }
    ...
    function testFinalBalance() public {
        ...
        console.log("acc[0] balance after charging contract:    ", acc0_InitialBalance);
        console.log("acc[0] final ether after balance:          ", acc0_FinalBalance);
        console.log("Gas paid by acc[0]:                        ", initialBalance - ((acc0_InitialBalance + initialBalance) - acc0_FinalBalance));
    ...
    function afterAll() public {
        ...
        // check remained tokens inside the Test contract
        ...
        console.log("TestMyToken contract balance:  ", address(this).balance);
